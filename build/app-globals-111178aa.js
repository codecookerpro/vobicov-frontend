import { E as ERROR_TRACKING_ENABLED, S as SENTRY_DSN } from './custom-88569afd.js';
...
var Logger = /** @class */ (function () {
    ...
    Logger.prototype.log = function () {
        ...
        consoleSandbox(function () {
            global$2.console.log(PREFIX + "[Log]: " + args.join(' ')); // tslint:disable-line:no-console
        });
    };
    /** JSDoc */
    Logger.prototype.warn = function () {
        ...
        consoleSandbox(function () {
            global$2.console.warn(PREFIX + "[Warn]: " + args.join(' ')); // tslint:disable-line:no-console
        });
    };
    /** JSDoc */
    Logger.prototype.error = function () {
        ...
        consoleSandbox(function () {
            global$2.console.error(PREFIX + "[Error]: " + args.join(' ')); // tslint:disable-line:no-console
        });
    };
    return Logger;
}());
...
var logger = global$2.__SENTRY__.logger || (global$2.__SENTRY__.logger = new Logger());
